...
const TASKS_STORAGE_KEY = "meridian_schedule_tasks";
const WEEKLY_STORAGE_KEY = "meridian_schedule_weekly";
const NOTES_STORAGE_KEY = "meridian_schedule_notes";
...
export default function App() {
  ...
  const [notesText, setNotesText] = useState(() => {
    ...
    return "Ideas for future development:\n- Add quick notes\n- Link notes to tasks\n- Support lightweight journaling";
  });
  ...
  useEffect(() => {
    localStorage.setItem(WEEKLY_STORAGE_KEY, JSON.stringify(weeklyPlanning));
  }, [weeklyPlanning]);

  useEffect(() => {
    localStorage.setItem(NOTES_STORAGE_KEY, notesText);
  }, [notesText]);
